...
### [2026-09-24] data：每日学习补录“海南/澄迈本地新闻”至 9 月（4 条，县情/省情时政）
- **改动**：`data.js` / `data.json` 的 `news` 数组新增 **4 条海南/澄迈本地官方新闻**，把本地类覆盖从 8 月中旬补齐到 9 月，总量 48 → 52 条，`updated` 改为 `2026-09-24 17:17`，按 `date` 降序排序（脚本同前，仅换 `NEW_ITEMS`）。
  - **澄迈（2 条，县情高频考点）**：①9/21 澄迈发布“十五五”规划纲要——锚定 GDP 年均增 7% 以上、冲刺“双千亿”（GDP 总量千亿 + 五年固投约 1400 亿/250+ 项目）、构建“541”现代化产业体系、“四个澄迈”战略定位；②9/21 澄迈提出从“工业大县”向“制造强县”跃迁——“十四五”末制造业产值破 150 亿、“十五五”末目标超 400 亿、工业门类全省最齐全/中小企业集群总量全省第一。
  - **海南（2 条，省情）**：③8/30 海南自贸港封关运作“成绩单”（长春发布会）——截至 7/31 “零关税”进口 36.24 亿增 40.1%、进出境旅客 181.8 万增 27.1%、税目比例 21%→74%/商品 6600 多种、清洁能源装机 87.2%、新能源车渗透率全国第一；④7/22 海南上半年 GDP 3813.45 亿增 2.0%（低于全国 4.7%，主动调结构阶段性反映）。
- **原因**：用户指出国家时政已补，但海南/澄迈本地类仍停在 8 月，要求“同步到 9 月”；尤其澄迈刚发布的“十五五”规划是县情必考点，必须补。
- **复刻要点**：本地类统一用 `tag='海南'` / `tag='澄迈'`；每条带 `备考提示` 标出“双千亿/541/年均7%”“封关启动日 2025-12-18”“零关税税目 74%”等踩分点；素材源为海南省统计局、海南日报、海南自贸港官网、中新网/新华网澄迈专场报道。
- **关联文件**：`data.js`、`data.json`；commit 见本日“补录本地新闻至 9 月”。
